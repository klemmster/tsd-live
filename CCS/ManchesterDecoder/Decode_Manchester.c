...
volatile unsigned char inBuffer[50];
...
volatile uint8_t T2Min = 200; //T2 - Ttolerance;

volatile uint8_t TMax = 200; //T + Ttolerance;
volatile uint8_t TMin = 103; //T - Ttolerance;
